namespace VideoClub.Data.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FirstName = c.String(),
                        LastName = c.String(),
                        UnreturnedRentals = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Rentals", "FilmId", "dbo.Films");
            DropForeignKey("dbo.Copies", "FilmId", "dbo.Films");
            ...
            DropIndex("dbo.Rentals", new[] { "FilmId" });
            DropIndex("dbo.Copies", new[] { "FilmId" });
